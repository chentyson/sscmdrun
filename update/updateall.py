...
threads.append(threading.Thread(target=update,args=("it1.boosoo.cn",)))
threads.append(threading.Thread(target=update,args=("hk1.boosoo.cn",)))
threads.append(threading.Thread(target=update,args=("hk2.boosoo.cn",)))
threads.append(threading.Thread(target=update,args=("tw1.boosoo.cn",)))
threads.append(threading.Thread(target=update,args=("tw2.boosoo.cn",)))
threads.append(threading.Thread(target=update,args=("sg1.boosoo.cn",)))
threads.append(threading.Thread(target=update,args=("sg2.boosoo.cn",)))
