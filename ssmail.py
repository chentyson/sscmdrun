...
def mailwillexp(cols,rows):
    ...
    text_content = u'尊敬的震撼网络用户：\n    您所使用的以下震撼网络账户：\n\n      端口:%s\n账户到期日:%s\n\n    即将到期，届时网络服务将自动停止。为了不影响您的正常使用，特提醒您提前续费。\n    您可扫描软件配置界面二维码续费，并支付时备注续费端口号，也可联系您的客服。'
    html_content = u'<!DOCTYPE html><html><body>尊敬的震撼网络用户，您所使用的以下震撼网络账户：<br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp服务器端口:<b>%s</b><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp账户到期日:<b>%s</b><br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp即将在&nbsp<b>%d天</b>&nbsp后到期>，届时网络服务将自动停止，为了不影响您的正常使用，特提醒您提前续费。可扫描软件配置界面二维码续费，并支付时备注续费端口号，也可联系您的客服。<br><br>震撼科技&nbsp&nbsp QQ:1716677<br>祝使用愉快！</body></html>'
...
def mailtest(cols,rows):
    ...
    for row in rows:
        ...
        subject = subject % port
        text_content = text_content % (port,startdate)
        html_content = html_content % (port,startdate)
        mail(subject,text_content,html_content,email)


def mailexp(cols,rows):
    subject = u'震撼网络服务到期暂停通知（%s）'
    text_content = u'尊敬的震撼网络用户，您所使用的以下震撼网络账户：\n\n    服务器端口: %s\n     账户到期日: %s\n\n    已经到期，服务已自动停止，如果您对我们的服务比较满意并且希望继续使用震撼网络服务，可扫描软件配置界面二维码续费，并支付时备注续费端口号，也可联系您的客服。\n\n震撼科技  QQ:1716677\n祝使用愉快！'

    html_content = u'<!DOCTYPE html><html><body>尊敬的震撼网络用户，您所使用的以下震撼网络账户：<br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp服务器端口:<b>%s</b><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp账户到期日:<b>%s</b><br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp已经到期，服务已自动停止，如果您对我们的服务比较满意并且希望继续使用震撼网络服务，可扫描软件配置界面二维码续费，并支付时备注续费端口号，也可联系您的客服。<br><br>震撼科技&nbsp&nbsp QQ:1716677<br>祝使用愉快！</body></html>'
...
def mailstoped(cols,rows):
    ...
    for email in emails:
        ports=u'<br>'.join(u'服务器端口:<b>%s</b>&nbsp&nbsp&nbsp账户到期日:&nbsp<b>%s</b>' % (port,enddate) for port,enddate in emails[email])
        text_content = u'  震撼网络用户您好，您所使用账户已经过期！如果您还有使用该服务的需求，可在震撼软件配置界面直接扫码支付，支付时备注你需要续费的端口号即可，我们将会自动按备注端口按续费日为您重新开通，端口/密码无需变更。也可联系您的客服续费。\n\n震撼网络服务是专为外贸商务提供的一种网络中转服务，速度快、运行稳定，并同时提供电脑Windows版本、苹果Macbook版本、手机安卓和苹果IOS版本的软件，可同时在电脑和手机等移动端在线使用。我们为个人用户同时也为公司多人同时在线使用提供不同的账户版本。咨询可联系下方QQ，或直接回复邮件。\n\n 震撼科技  QQ:1716677 \n祝使用愉快！\n'
        html_content = u'<!DOCTYPE html><html><body>震撼网络用户您好，您使用的下列账户已经过期：<br><br>%s<br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp您还需要该服务吗？ 如果需要可在震撼软件配置界面直接扫码支付，注意支付时备注您需要续费的端口号即可，如果忘记备注请联系您的客服，端口/密码无需变更。当然您也可联系您的客服进行续费操作。<br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp震撼网络服务是专为外贸提供的网络中转解决方案，速度快、运行稳定，服务期内提供7×24小时售后技术支持。 我们同时提供Windows版本、Macbook版本、手机的安卓和苹果版本软件。可同时在电脑和手机使用。同时提供个人版和多人同时在线的多人版本。咨询可联系下方QQ，或直接回复邮件。<br><br>如您不再希望收到收件提醒，可直接回复内容为“不再提醒”的邮件即可！<br><br> 震撼科技&nbsp&nbsp QQ:1716677<br>祝使用愉快！</body></html>' % ports
        mail(subject,text_content,html_content,email)
